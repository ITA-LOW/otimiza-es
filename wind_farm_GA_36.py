...
from mono_objetivo.plot import plot_solution_circle
...
config_dir = "config"
main_yaml_path = os.path.join(config_dir, 'iea37-ex36.yaml')
...
toolbox.register("mutate", mutate, mu=0, sigma=100, indpb=0.1) 
...
def main():
    ...
    for gen in range(1, NGEN + 1):
        ...
        if len(gens) > 9:
            ax1.plot(gens[9:], max_fitness[9:], 'b-', label='Max Fitness')
        else:
