...
initial_coordinates, _, _ = getTurbLocYAML('artigo_1/iea37-ex16.yaml')
...
def evaluate(individual):
    ...
    turb_coords, fname_turb, fname_wr = getTurbLocYAML("artigo_1/iea37-ex16.yaml")
...
def main():
    ...
    pop, logbook = algorithms.eaSimple(pop, toolbox, cxpb=0.95, mutpb=0.55, ngen=300, 
